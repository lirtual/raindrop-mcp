...
- `npm publish --provenan: deletes existing release first, then creates new one
- GitHub release creation with `--clobber` (overwrites existing releases)
...
4. **Verify package installation:**
   ```bash
   npm install @adeze/raindrop-mcp@2.1.1
   ```
